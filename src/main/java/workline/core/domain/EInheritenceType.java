...
public enum EInheritenceType {
    INHERIT {
        ...
        @Override
        protected void setOwnValue(IRepoHandler repoHandler, RepoItem repoItem, RepoItem inheritenceSource, String attributeName, Object value) {
            // Do nothing.
        }
    },
    OVERRIDE {
        @TODO(tags = { TODOTag.SPECIFICATION_REQUIRED })
        @Override
        protected void setInheritingValue(IRepoManager repoManager, IRepoHandler repoHandler, RepoItem repoItem, RepoItem inheritenceSource,
    ...
    protected void setValue(IRepoManager repoManager, IRepoHandler repoHandler, RepoItem repoItem, RepoItem inheritenceSource, String attributeName,
            Object value) {
        setOwnValue(repoHandler, repoItem, inheritenceSource, attributeName, value);
        setInheritorValues(repoManager, repoHandler, repoItem, attributeName, value);
    }

    protected void setOwnValue(IRepoHandler repoHandler, RepoItem repoItem, RepoItem inheritenceSource, String attributeName, Object value) {
        repoHandler.setValue(repoItem, inheritenceSource, attributeName, value);
    }
    ...
    protected void setInheritingValue(IRepoManager repoManager, IRepoHandler repoHandler, RepoItem repoItem, RepoItem inheritenceSource, String attributeName,
            Object value) {

        setValue(repoManager, repoHandler, repoItem, inheritenceSource, attributeName, value);
    }
